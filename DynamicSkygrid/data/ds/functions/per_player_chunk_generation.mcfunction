...
execute store result entity @e[limit=1,type=minecraft:armor_stand, tag=ds_SELECTED_BC] Pos[0] double 1 run scoreboard players get @a[limit=1, tag=ds_SELECTED_PLAYER] ds_Chunk_Base_X
...
execute store result entity @e[limit=1,type=minecraft:armor_stand, tag=ds_SELECTED_BC] Pos[2] double 1 run scoreboard players get @a[limit=1, tag=ds_SELECTED_PLAYER] ds_Chunk_Base_Z
